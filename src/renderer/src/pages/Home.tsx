...
export function Home() {
      ...
      <div className="flex flex-col items-center justify-center h-full p-8">
        <div className="text-center max-w-md">
          ...
          <div className="flex flex-col gap-2 w-full">
            <Button className="w-full" onClick={() => navigate('/setlist')}>
  ...
  if (activeItem && activeItem.id && typeof activeItem.id === 'string') {
    return (
      <div className="p-4">
        <DndContext key={activeItem.id} sensors={sensors} collisionDetection={closestCenter}>
  ...
  return (
    <div className="flex items-center justify-center h-full">
      <div className="text-center">
        ...
        <Button variant="link" onClick={() => navigate('/setlist')} className="mt-2">

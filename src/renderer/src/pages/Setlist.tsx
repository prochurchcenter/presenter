          ...
          <Card>
            ...
            <CardContent className="px-2">
              {isLoading ? (
                ...
                <div className="text-center p-4 text-muted-foreground">No services found</div>
              )}
            </CardContent>
          </Card>
        </div>
              ...
              <CardHeader>
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <CardDescription>{selectedService.date}</CardDescription>
                  </div>
...
function AddItemForm({ collections, onAddItem, onCancel }: AddItemFormProps) {
  ...
  const filteredItems = (
    activeTab === 'songs' ? collections.songs : collections.presentations
      ...
      <DialogFooter>
        {formStep === 'preview' ? (
          <div className="flex justify-between w-full">
            <Button type="button" variant="outline" onClick={() => setFormStep('select')}>
              Back
            </Button>
            <div className="space-x-2">
              ...
              <Button type="button" onClick={handleAddItemWithSettings}>
                Add to Service
              </Button>
            </div>
          </div>
